      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="lg:w-1/2 space-y-6 lg:pr-8">
          <div className="max-w-lg mx-auto lg:mx-0">
            <h2 className="text-lg mb-4 underline text-center lg:text-left font-medium">Apprendre à me connaître</h2>
            <p className="text-lg mb-4 font-light leading-relaxed text-base-content">
              Je suis un <strong>développeur web full stack</strong> orienté front-end, qui conçoit et gère l&apos;interface des sites et applications web contribuant directement à la réussite du produit final. Tu peux découvrir mon travail dans la section <strong>Projets</strong>.
            </p>
            ...
            <p className="text-lg font-light leading-relaxed text-base-content">
        ...
        <div className="lg:w-1/2 flex flex-col">
          <div className="max-w-xl mx-auto lg:mx-0 pl-10 pr-10">
            <h2 className="text-lg underline mb-4 text-center lg:text-left">Mes technologies</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              {technologies.map((tech) => (
                <div
                  key={tech.name}
                  className="badge badge-primary badge-sm p-6 text-base flex items-center justify-center w-full"
                >
                  {tech.name}
                </div>
              ))}
